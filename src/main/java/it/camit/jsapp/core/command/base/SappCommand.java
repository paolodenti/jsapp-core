...
public class SappCommand {
	 ...
	 *
	 * @param sappConnection  A {@code SappConnection} possibly created by {@link it.camit.jsapp.core.command.base.SappConnection SappConnection}
	 */
	 ...
	 *
	 * @param socketChannel  The actual {@code SocketChannel} obtained by {@link it.camit.jsapp.core.command.base.SappConnection#getSocketChannel() getSocketChannel}
	 */
