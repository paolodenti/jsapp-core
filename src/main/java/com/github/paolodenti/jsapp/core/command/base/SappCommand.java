...
public class SappCommand {
     ...
     *
     * @param socketChannel The actual {@code SocketChannel} obtained by {@link com.github.paolodenti.jsapp.core.command.base.SappConnection#getSocketChannel() getSocketChannel}
     */
