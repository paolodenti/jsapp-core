...
package it.camit.jsapp.core.command.base;
...
public class SappResponse {
	 ...
	 *
	 *  @param status  response status ({@link it.camit.jsapp.core.util.SappConstants#RES_OK RES_OK} if ok, {@link it.camit.jsapp.core.util.SappConstants#RES_KO RES_KO} otherwise)
	...
	/**
	 *  @return response status ({@link it.camit.jsapp.core.util.SappConstants#RES_OK RES_OK} if ok, {@link it.camit.jsapp.core.util.SappConstants#RES_KO RES_KO} otherwise)
	 */
